...
// product matches from the FoodSearching seam (OpenFoodFacts), and parsing via the
// FoodParsing seam (the OpenAI proxy). In AppCore so the orchestration is
// unit-tested with stub seams.
