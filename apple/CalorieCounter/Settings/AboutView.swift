    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Barcode and branded-product nutrition comes from the Open Food Facts database, made available under the Open Database License (ODbL). Calorie and macro estimates for typed, spoken, and photographed food are generated by OpenAI and are approximate — always check and adjust them before saving.")
            }
